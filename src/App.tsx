  ...
  return (
    <div className="min-h-screen transition-colors duration-500 bg-[#fafafa] dark:bg-[#09090b] text-neutral-900 dark:text-neutral-50 selection:bg-indigo-500/30 relative flex flex-col">
      ...
      <nav className="sticky top-0 z-40 w-full backdrop-blur-3xl bg-white/80 dark:bg-[#09090b]/80 border-b border-neutral-200 dark:border-neutral-800">
        <div className="max-w-6xl mx-auto px-2 md:px-8 h-16 flex items-center justify-between relative">
          <div className="font-bold text-lg tracking-tight flex items-center gap-2 z-10">
          ...
          <div className="absolute left-1/2 -translate-x-1/2 flex bg-neutral-100 dark:bg-neutral-900/80 p-1 rounded-full border border-neutral-200 dark:border-neutral-800">
            <button
              ...
              className={`relative z-10 outline-none overflow-hidden px-4 sm:px-6 py-1.5 rounded-full text-xs sm:text-sm font-semibold transition-colors duration-300 focus:outline-none cursor-pointer ${activeView === "showcase"
            ...
            <button
              ...
              className={`relative z-10 outline-none overflow-hidden px-4 sm:px-6 py-1.5 rounded-full text-xs sm:text-sm font-semibold transition-colors duration-300 focus:outline-none cursor-pointer ${activeView === "docs"
                ? "text-neutral-900 dark:text-white"
                : "text-neutral-500 hover:text-neutral-900 dark:hover:text-white"
                }`}
            >
        ...
        <AnimatePresence mode="wait">
          {activeView === "showcase" ? (
            <motion.main
              ...
              className="max-w-4xl mx-auto w-full flex flex-col space-y-10 md:space-y-16 py-10 md:py-12 px-4 md:px-8"
            >
              <header className="text-center space-y-5 md:space-y-6">
                <motion.div
                  ...
                  className="inline-flex items-center justify-center px-4 py-1.5 mb-2 rounded-full bg-indigo-50 dark:bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 font-medium text-[10px] md:text-xs tracking-widest uppercase ring-1 ring-inset ring-indigo-500/20"
                >
              ...
              <section className="grid grid-cols-1 md:grid-cols-2 items-start gap-4 md:gap-6 pb-8">
                <DemoCard
                  ...
                  codeSnippets={{
                    react: `import Ripple from '@nuttawoot_donut/react-ripple';\n\nexport default function App() {\n  const ripple = new Ripple();\n\n  return (\n    <button onPointerDown={(e) => ripple.create(e)}>\n      Click to Ripple\n    </button>\n  );\n}`,
                    ...
                    html: `<script src="https://cdn.jsdelivr.net/npm/@nuttawoot_donut/react-ripple/ripple.js"></script>\n\n<button onpointerdown="ripple.create(event)">\n  Click to Ripple\n</button>\n\n<script>\n  const ripple = new window.Ripple();\n</script>`,
                  }}
                  isDark={isDark}
                ...
                <DemoCard
                  ...
                  codeSnippets={{
                    react: `import Ripple from '@nuttawoot_donut/react-ripple';\n\nexport default function App() {\n  const ripple = new Ripple();\n\n  return (\n    <button onPointerDown={(e) => ripple.create(e, "light")}>\n      Light Ripple\n    </button>\n  );\n}`,
                    vue: `<template>\n  <button @pointerdown="ripple.create($event, 'light')">\n    Light Ripple\n  </button>\n</template>\n\n<script setup>\nimport Ripple from '@nuttawoot_donut/react-ripple';\nconst ripple = new Ripple();\n</script>`,
                    svelte: `<script>\n  import Ripple from '@nuttawoot_donut/react-ripple';\n  const ripple = new Ripple();\n</script>\n\n<button on:pointerdown={(e) => ripple.create(e, 'light')}>\n  Light Ripple\n</button>`,
                    html: `<script src="https://cdn.jsdelivr.net/npm/@nuttawoot_donut/react-ripple/ripple.js"></script>\n\n<button onpointerdown="ripple.create(event, 'light')">\n  Light Ripple\n</button>\n\n<script>\n  const ripple = new window.Ripple();\n</script>`,
                  }}
                  isDark={isDark}
                ...
                <DemoCard
                  ...
                  codeSnippets={{
                    react: `import Ripple from '@nuttawoot_donut/react-ripple';\n\nexport default function App() {\n  const ripple = new Ripple();\n\n  return (\n    <button onPointerDown={(e) => ripple.create(e, "dark")}>\n      Dark Ripple\n    </button>\n  );\n}`,
                    vue: `<template>\n  <button @pointerdown="ripple.create($event, 'dark')">\n    Dark Ripple\n  </button>\n</template>\n\n<script setup>\nimport Ripple from '@nuttawoot_donut/react-ripple';\nconst ripple = new Ripple();\n</script>`,
                    svelte: `<script>\n  import Ripple from '@nuttawoot_donut/react-ripple';\n  const ripple = new Ripple();\n</script>\n\n<button on:pointerdown={(e) => ripple.create(e, 'dark')}>\n  Dark Ripple\n</button>`,
                    html: `<script src="https://cdn.jsdelivr.net/npm/@nuttawoot_donut/react-ripple/ripple.js"></script>\n\n<button onpointerdown="ripple.create(event, 'dark')">\n  Dark Ripple\n</button>\n\n<script>\n  const ripple = new window.Ripple();\n</script>`,
                  }}
                  isDark={isDark}
            ...
            <motion.main
              ...
              exit={{ opacity: 0, y: -20 }}
              transition={{ duration: 0.3 }}
              className="max-w-6xl mx-auto w-full flex flex-col md:flex-row gap-8 py-4 md:py-8 px-4 md:px-8"
            >
